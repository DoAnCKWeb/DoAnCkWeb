...
router.get('/', async (req, res) => {
  try {
      ...
      res.render('customerViews/categoriesAndProducts', { categories, products , message: req.query.message,role });
  } catch (err) {
...
router.get('/user/:id/products', async (req, res) => {
  ...
  try {
      ...
      if (category) {
          res.render('customerViews/productsByCategory', { products, category, isLoggedIn,role });
      } else {
